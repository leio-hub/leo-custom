...
function load_js(){
    ...
    wp_register_script('gsap', get_template_directory_uri() . '/node_modules/gsap/dist/gsap.min.js', 
        array('jquery'), false, true);
    wp_enqueue_script('gsap');
    
    wp_register_script('scroll-trigger', get_template_directory_uri() . '/node_modules/gsap/dist/ScrollTrigger.min.js', 
        array('gsap'), false, true);
    wp_enqueue_script('scroll-trigger');
    
    wp_register_script('lenis', get_template_directory_uri() . '/node_modules/@studio-freight/lenis/dist/lenis.min.js', 
        array('jquery'), false, true);
    wp_enqueue_script('lenis');
    
    wp_register_script('split-type', get_template_directory_uri() . '/node_modules/split-type/dist/index.js', 
        array('jquery'), false, true);
    wp_enqueue_script('split-type');

    wp_register_script('swup', get_template_directory_uri() . '/node_modules/swup/dist/Swup.umd.js', 
        array(), false, true);
    wp_enqueue_script('swup');

    wp_register_script('barbajs', 'https://cdn.jsdelivr.net/npm/@barba/core', 
        array(), false, true);
